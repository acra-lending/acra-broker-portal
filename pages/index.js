      ...
      <main>
            {isLoading ? (
              ...
              isLogged ? (
                ...
                <>
                  <div className="h-screen px-12 flex space-x-4 flex-col xl:flex-row xl:px-32 lg:flex-row lg:px-24 md:flex-row md:px-24 md:pt-32 sm:flex sm:flex-col sm:space-x-0 sm:px-6 bg-[url('https://api.acralending.com/uploads/careers_navybg_b874f0bbad.jpg')] bg-cover">
                    <div>
