...
function formsTable({menuItems, formsItems}) {
    ...
    const URL = `https://7abe-107-194-134-60.ngrok.io/api/corr-portal-resources?pagination[page]=${pageNumber}&pagination[pageSize]=10&populate=*`;
...
export async function getServerSideProps() {
    const [menuResponse, formsResponse] = await Promise.all([
      ...
      fetch(`${process.env.BASE_URL}/corr-portal-resources?pagination[page]=1&pagination[pageSize]=8&populate=*`)
    ]); 
