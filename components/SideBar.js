...
export default function SideBar ({ props }) {
    ...
    const sideBarMobileClassNames = 'h-full w-64 z-40 bg-white absolute inset-y-0 left-0 transform md:relative md:translate-x-0 transition duration-200 ease-in-out border-r shadow-md';
